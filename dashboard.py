...
# =============================================================================
    ...
    # Data directories
    INDEX_DATA_DIR = r"C:\Users\patel\OneDrive\Desktop\Code\NSE_Indices_Data"
    MONETARY_DATA_FILE = r"C:\Users\patel\OneDrive\Desktop\Code\Components of Money stock.XLSX"
    GLOBAL_DATA_DIR = r"C:\Users\patel\OneDrive\Desktop\Code\Global_Indices_Data"
...
# =============================================================================
    ...
    # FNO data file path
    FNO_DATA_FILE = r"C:\Users\patel\OneDrive\Desktop\Code\fii-dii_historical_data(nse).csv"
    ...
    if fno_df is not None:
        ...
        client_types = fno_df['Client Type'].unique().tolist()
        
        # Create sub-tabs for each client type
        fno_tabs = st.tabs([f"📊 {ct}" for ct in client_types])
